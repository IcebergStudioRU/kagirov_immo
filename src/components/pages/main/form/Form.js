                ...
                <div className='max-w-mobileContainer mx-auto pt-16 pb-10 px-5 flex flex-col items-center'>
                    ...
                    <form className='flex flex-col items-center'>
                        <label className='flex flex-col mb-4 relative align-middle'>
                            <p className='font-Montserrat text-inputFormBorderColor text-xs'>Name</p>
                        ...
                        <label className='flex flex-col relative align-middle mb-12'>
                            <p className='font-Montserrat text-inputFormBorderColor text-xs' type="text">E-mail</p>
                        ...
                        <div>
                            <button className='df w-32 h-10 bg-formBtnColor rounded text-white shadow-xl font-Montserrat text-xl'>
                                Contact Us!
                            </button>
                        </div>
                    </form>

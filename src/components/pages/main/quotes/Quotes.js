        ...
        <div className='bg-QuotesBg'>
            <div className='bg-quotesMeImage bg-bottom bg-no-repeat '>
                <div className=' max-w-mobileContainer mx-auto pt-16 pb-3 px-5 flex flex-col items-center'>
                    ...
                    <p className='font-Montserrat text-center text-white mb-14'>I don't work for quantity.  It is important to me<br/>that my clients receive my services<br/>of the highest quality!</p>
